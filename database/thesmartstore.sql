...
--
-- Máy chủ: sql207.epizy.com
-- Thời gian đã tạo: Th3 04, 2020 lúc 06:53 AM
...
--
-- Cơ sở dữ liệu: `epiz_20895901_thesmartstore`
--
...
(5, 2, '', '', 'xde', '2017-11-02 10:39:54', '2017-11-02 14:39:54', '2017-11-02 14:39:54'),
(6, 2, '', '', 'fhfgh', '2017-11-02 10:40:47', '2017-11-02 14:40:47', '2017-11-02 14:40:47'),
(7, 2, '', '', 'fhfgh', '2017-11-02 10:40:47', '2017-11-02 14:40:47', '2017-11-02 14:40:47'),
(8, 19, 'Đỗ Phước Lộc', 'doloccit@gmail.com', 'hết rồi', '2017-11-25 01:54:20', '2017-11-25 06:54:20', '2017-11-25 06:54:20');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `chi_tiet_dien_thoais`
--
...
--
-- Đang đổ dữ liệu cho bảng `chi_tiet_dien_thoais`
--
...
--
-- Cấu trúc bảng cho bảng `chi_tiet_lap_tops`
--
...
--
-- Cấu trúc bảng cho bảng `chi_tiet_phieu_dat_hangs`
--
...
--
-- Đang đổ dữ liệu cho bảng `chi_tiet_phieu_dat_hangs`
--
...
--
-- Cấu trúc bảng cho bảng `dien_thoais`
--
...
--
-- Đang đổ dữ liệu cho bảng `dien_thoais`
--
...
(23, 'Asus Zenfone Go ZC500TG', 6, 1, 'Điện thoại giá sinh viên, cấu hình mạnh mẽ', 98, 2, NULL, NULL, '2016-10-28 21:51:54', '2016-10-28 21:51:54'),
(25, 'Iphone SE', 1, 1, 'Test, test', 10, 0, NULL, NULL, '2018-12-03 06:59:27', '2018-12-03 06:59:27'),
(26, 'Iphone SE', 1, 1, 'Test, test', 10, 0, NULL, NULL, '2018-12-03 07:01:56', '2018-12-03 07:01:56');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `gia_dien_thoais`
--
...
--
-- Đang đổ dữ liệu cho bảng `gia_dien_thoais`
--
...
--
-- Cấu trúc bảng cho bảng `gia_lap_tops`
--
...
--
-- Cấu trúc bảng cho bảng `hang_san_xuats`
--
...
--
-- Đang đổ dữ liệu cho bảng `hang_san_xuats`
--
...
--
-- Cấu trúc bảng cho bảng `hinh_anh_dien_thoais`
--
...
--
-- Đang đổ dữ liệu cho bảng `hinh_anh_dien_thoais`
--
...
--
-- Cấu trúc bảng cho bảng `hinh_anh_laps`
--
...
(56, 'Đỗ Phước Lộc', 'Nam', 'doloccit@gmail.com', '01232424143', 'eweeweq', '2017-12-09 15:46:31', '2017-12-09 15:46:31');
...
--
-- Cấu trúc bảng cho bảng `loai_hinh_anhs`
--
...
--
-- Đang đổ dữ liệu cho bảng `loai_hinh_anhs`
--
...
--
-- Đang đổ dữ liệu cho bảng `loai_nguoi_dungs`
--
...
--
-- Cấu trúc bảng cho bảng `phieu_dat_hang_dien_thoais`
--
...
--
-- Đang đổ dữ liệu cho bảng `phieu_dat_hang_dien_thoais`
--
...
(38, 50, '2.990.000', '2016-11-03', '2017-11-25', 'Thanh toán tại cửa hàng', 2, 3, '2016-11-02 20:53:51', '2016-11-02 20:53:51');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `quang_caos`
--
...
--
-- Đang đổ dữ liệu cho bảng `quang_caos`
--
...
(3, 'Đỗ Phước Lộc', 'doloccit@gmail.com', '$2y$10$2i.Gzbfrsr8XWwufOIwuS.5WVUsJ.IopscwdEQNvMFE5T6MXvlkmG', 1, 1, 'PeVZaon5e2eY6OYcXvWhC1uwZV0zLDmVEPuX2Yc4lL8gRKEtper4HarOqC8c', '2016-10-12 18:33:59', '2019-03-27 21:32:53'),
...
--
-- Chỉ mục cho bảng `chi_tiet_dien_thoais`
--
...
--
-- Chỉ mục cho bảng `chi_tiet_lap_tops`
--
...
--
-- Chỉ mục cho bảng `chi_tiet_phieu_dat_hangs`
--
...
--
-- Chỉ mục cho bảng `gia_dien_thoais`
--
...
--
-- Chỉ mục cho bảng `hang_san_xuats`
--
ALTER TABLE `hang_san_xuats`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `hinh_anh_dien_thoais`
--
...
--
-- Chỉ mục cho bảng `hinh_anh_laps`
--
...
--
-- Chỉ mục cho bảng `loai_hinh_anhs`
--
...
--
-- Chỉ mục cho bảng `phieu_dat_hang_dien_thoais`
--
...
--
-- AUTO_INCREMENT cho bảng `chi_tiet_dien_thoais`
--
ALTER TABLE `chi_tiet_dien_thoais`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_lap_tops`
--
ALTER TABLE `chi_tiet_lap_tops`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `chi_tiet_phieu_dat_hangs`
--
ALTER TABLE `chi_tiet_phieu_dat_hangs`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;

--
-- AUTO_INCREMENT cho bảng `dien_thoais`
--
ALTER TABLE `dien_thoais`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;

--
-- AUTO_INCREMENT cho bảng `gia_dien_thoais`
--
ALTER TABLE `gia_dien_thoais`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `gia_lap_tops`
--
ALTER TABLE `gia_lap_tops`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `hang_san_xuats`
--
ALTER TABLE `hang_san_xuats`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT cho bảng `hinh_anh_dien_thoais`
--
ALTER TABLE `hinh_anh_dien_thoais`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=161;

--
-- AUTO_INCREMENT cho bảng `hinh_anh_laps`
--
ALTER TABLE `hinh_anh_laps`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT cho bảng `loai_hinh_anhs`
--
ALTER TABLE `loai_hinh_anhs`
...
--
-- AUTO_INCREMENT cho bảng `phieu_dat_hang_dien_thoais`
--
ALTER TABLE `phieu_dat_hang_dien_thoais`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;

--
-- AUTO_INCREMENT cho bảng `quang_caos`
--
ALTER TABLE `quang_caos`
