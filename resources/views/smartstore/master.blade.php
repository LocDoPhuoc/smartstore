...
<head>
	...
	{{--<link rel="stylesheet" href="{!! url('/smartstore/css/bootstrap.min.css') !!}">--}}
	<script src="{!!asset('/smartstore/js/jquery-1.11.3.min.js')!!}" ></script>
	<link rel="stylesheet" type="text/css" href="{!! url('/smartstore/css/mobileCSS.css') !!}">
	<script src="{!!asset('/smartstore/js/smartstoreJS.js')!!}"></script>
	<script src="{!!asset('/smartstore/js/shopping.js')!!}"></script>
					...
					<ul class="nav navbar-nav myNav ">
						<li class="dropdown style-hover" id="l1" >
							<a href="{!! route('dienthoai.index')!!}" id="a-l1">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/mobile.ico')!!}"></img>
									</label>
								</span>
...
{{-- 						<li class="dropdown style-hover" id="l2">
							<a href="#" id="a-l2">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/Laptop.jpg')!!}" ></img>
									</label>
								</span>
						...
						{{-- <li class="dropdown style-hover" id="l3">
							<a href="#" id="a-l3">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/tablet.jpg')!!}"></img>
									</label>
								</span>
						...
						<li class="dropdown style-hover" id="l4">
							<a href="{!! route('home.apple') !!}" id="a-l4">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/apple.png')!!}" ></img>
									</label>
								</span>
						...
						<li class="dropdown style-hover" id="l4">
							<a href="{!! route('home.samsung') !!}" id="a-l4">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/samsung.png')!!}" ></img>
									</label>
								</span>
						...
						<li class="dropdown style-hover" id="l4">
							<a href="{!! route('home.sony') !!}" id="a-l4">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/sony.png')!!}" ></img>
									</label>
								</span>
					...
					<ul class="nav navbar-nav navbar-right myNav">
						<li style="border-top: 3px solid white;">
							<a href="{!! route('shopping') !!}">
								<span>
									<label >
										<img class="myIcons" src="{!! asset('/smartstore/icons/shopping-cart.ico')!!}">
...
s1.async=true;
s1.src='https://embed.tawk.to/5a109795198bd56b8c03bf5c/default';
s1.charset='UTF-8';
